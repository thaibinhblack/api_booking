...
class EMAILAPI extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Mail::send('Email', array(
	        ...
	        $message->to(
                ['thaibinhblack@gmail.com','binhb1509909@student.ctu.edu.vn'], 'Thông báo')->subject('Thông báo có khách hàng booking!');
                $message->from('thaibinhblack@gmail.com','Hệ thống quản lý booking');
	    });
