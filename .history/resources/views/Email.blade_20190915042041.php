<style>
    ...
    <center class="wrapper">
        <table class="top-panel center" width="602" border="0" cellspacing="0" cellpadding="0">
            <tbody>
            <tr>
                <td class="title" width="300">Booking</td>
                <td class="subject" width="300"><a class="strong" href="#" target="_blank">booking.duyanhplus.com</a></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="column">
                    ...
                    <table class="content" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td class="padded">
                                <h1>Thông báo có khách hàng booking tại chi nhánh bạn quản lý</h1>
                                <p>Thông tin khách hàng như sau:</p>
                                <p><strong>Họ & Tên: </strong> {{NAME_BOOKING}}</p>
                                {{-- <p><strong>Số điện thoại: </strong> {{PHONE_BOOKING}}</p>
                                <p><strong>Lịch hẹn: </strong> {{TIME_BOOK}}, ngày {{DATE_BOOK}}</p>
                                <P><strong>Đặt lịch vào lúc: </strong> {{CREATED_AT}}</P> --}}
                            </td>
                        </tr>
                        </tbody>
                    </table>
        ...
        <table class="footer center" width="602" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="signature" width="300">
                    <p>Mời bạn vào hệ thống để check lịch cho khách hàng</p>
                    <p>
                        Support: <a class="strong" href="mailto:#" target="_blank">thaibinhblack@gmail.com</a>
                    </p>
                </td>
            </tr>
            </tbody>
